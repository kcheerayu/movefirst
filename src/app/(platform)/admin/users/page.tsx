...
export default async function Users() {
  ...
  return <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
    <div className="flex justify-between"><div><p className="text-xs tracking-[.16em] text-[#8d8f88]">ADMINISTRATION</p><h1 className="mt-3 text-3xl tracking-tight">Team</h1></div><InviteUserForm agents={agentChoices??[]} clients={clientChoices??[]}/></div>
